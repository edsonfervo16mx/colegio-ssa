...
?>
		...
		<body>
			...
			<div class="container area">
				<?php
					require_once 'module/colegiaturacuenta/form.add.colegiaturacuenta.php';
					require_once 'module/colegiaturacuenta/script.js.load.inputs.prices.php';
				?>
			</div>
			</main>
			<!-- /container -->
			<?php 
				...
				require_once 'module/colegiaturacuenta/json.data.php';
			?>
		</body>
		</html>
<?php 
