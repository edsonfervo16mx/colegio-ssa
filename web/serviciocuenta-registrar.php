...
?>
		...
		<body>
			...
			<div class="container area">
				<?php
					require_once 'module/serviciocuenta/form.add.serviciocuenta.php';
					require_once 'module/serviciocuenta/script.js.load.inputs.prices.php';
				?>
			</div>
			</main>
			<!-- /container -->
			<?php 
				...
				require_once 'module/serviciocuenta/json.data.php';
			?>
		</body>
		</html>
<?php 
